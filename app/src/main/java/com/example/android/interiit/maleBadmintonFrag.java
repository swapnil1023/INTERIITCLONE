...
public class maleBadmintonFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        badF.collection("Badminton").document("male").collection("matches").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                task = badF.collection("Badminton").document("male").collection("matches").document(String.valueOf(i+1)).get();
